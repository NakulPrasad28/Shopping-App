...
import 'package:pro/core/extensions.dart';
import 'package:pro/src/model/product.dart';
import 'package:pro/src/model/numerical.dart';
import 'package:get/get_state_manager/get_state_manager.dart';
import 'package:pro/src/model/product_category.dart';
import 'package:pro/src/model/product_size_type.dart';

class ProductController extends GetxController {
  List<Product> allProducts = AppData.products.obs;
  List<Product> filteredProducts = AppData.products.obs;
  List<Product> cartProducts = <Product>[].obs;
  List<ProductCategory> categories = AppData.categories.obs;
